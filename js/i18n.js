...
const I18N = (() => {
  ...
  const STRINGS = {
    es: {
      ...
      hint_request_button: "💡 Pedir una pista (−{cost} ducados)",
      ...
      license_bundle_note: "Incluye también «Tabernas con Historia». Al pagar recibiréis dos códigos, uno para cada aventura.",
      ...
      leaderboard_team_placeholder: "Ej.: Los Cronistas",
      ...
      speaker_quiz: "os reta con una pregunta relámpago",
      quiz_kicker: "Prueba extra",
      quiz_title: "Pregunta relámpago",
      quiz_correct: "¡Correcto! +{pts} ducados",
      quiz_incorrect: "No era esa — la respuesta correcta era otra.",
      quiz_continue: "Continuar →",
      quiz_log_label: "🎯 Prueba extra — {location}",
    ...
    en: {
      ...
      hint_request_button: "💡 Ask for a hint (−{cost} ducats)",
      ...
      license_bundle_note: "Also includes \"Tabernas con Historia.\" You'll receive two codes at checkout, one for each adventure.",
      ...
      leaderboard_team_placeholder: "E.g.: The Chroniclers",
      ...
      speaker_quiz: "challenges you with a lightning question",
      quiz_kicker: "Bonus challenge",
      quiz_title: "Lightning question",
      quiz_correct: "Correct! +{pts} ducats",
      quiz_incorrect: "Not quite — the correct answer was a different one.",
      quiz_continue: "Continue →",
      quiz_log_label: "🎯 Bonus challenge — {location}",
    ...
    fr: {
      ...
      hint_request_button: "💡 Demander un indice (−{cost} ducats)",
      ...
      license_bundle_note: "Comprend aussi « Tabernas con Historia ». Vous recevrez deux codes après le paiement, un pour chaque aventure.",
      ...
      leaderboard_team_placeholder: "Ex. : Les Chroniqueurs",
      ...
      speaker_quiz: "vous lance une question éclair",
      quiz_kicker: "Épreuve bonus",
      quiz_title: "Question éclair",
      quiz_correct: "Correct ! +{pts} ducats",
      quiz_incorrect: "Ce n'était pas ça — la bonne réponse était une autre.",
      quiz_continue: "Continuer →",
      quiz_log_label: "🎯 Épreuve bonus — {location}",
