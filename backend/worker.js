...
const STAGES_I18N = [
  ...
  },
  {
    ...
    freeTourIntro: {
      es: "Ya se ve el Palacio Real al fondo: dejadme contaros cómo llegó a tener delante esta plaza tan despejada. La abrió, en parte, el mismo rey del que ya os hablé en la Plaza de Santa Ana: José Bonaparte, «Pepe Plazuelas», que en 1811 mandó derribar aquí dos conventos, una iglesia y 56 casas para dar perspectiva al Palacio. Pero el diseño que veis hoy —los jardines, la disposición rectangular— no es el suyo: se aprobó en 1844, ya bajo el reinado de Isabel II, obra del arquitecto Narciso Pascual y Colomer. A un lado se alza el Teatro Real, y al otro, el Real Monasterio de la Encarnación. Aquí, frente al Palacio Real, se cierra por fin vuestra búsqueda del Testamento del Siglo de Oro.",
      en: "You can already see the Royal Palace ahead: let me tell you how it came to have this open square in front of it. It was partly opened by the same king I told you about at Plaza de Santa Ana: Joseph Bonaparte, 'Pepe Plazuelas,' who in 1811 had two convents, a church and 56 houses torn down here to give the Palace some perspective. But the design you see today — the gardens, the rectangular layout — isn't his: it was approved in 1844, under the reign of Isabel II, the work of architect Narciso Pascual y Colomer. On one side stands the Teatro Real, and on the other, the Royal Monastery of the Incarnation. Here, facing the Royal Palace, your search for the Golden Age Testament finally comes to a close.",
      fr: "On aperçoit déjà le Palais Royal au loin : laissez-moi vous raconter comment cette place si dégagée est apparue devant lui. Elle fut ouverte, en partie, par le même roi dont je vous ai parlé Plaza de Santa Ana : Joseph Bonaparte, « Pepe Plazuelas », qui en 1811 fit démolir ici deux couvents, une église et 56 maisons pour donner de la perspective au Palais. Mais le dessin que vous voyez aujourd'hui — les jardins, la disposition rectangulaire — n'est pas le sien : il fut approuvé en 1844, sous le règne d'Isabelle II, œuvre de l'architecte Narciso Pascual y Colomer. D'un côté se dresse le Teatro Real, et de l'autre, le Monastère royal de l'Incarnation. C'est ici, face au Palais Royal, que se termine enfin votre quête du Testament du Siècle d'Or.",
    },
